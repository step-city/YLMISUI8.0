            ...
            <el-row>
                <el-col :span="12">
                    <el-form-item label="上级名称" prop="parentId">
                        <yl-organizeTree v-model="formModel.parentId" @getCurrentNode="_getParentOrg" :placeholder="'请选择上级名称'" :isexpand="false"></yl-organizeTree>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item label="排序" prop="sortCode">
                        <el-input-number style="width:100%" v-model="formModel.sortCode" :min="1"></el-input-number>
                    </el-form-item>
                </el-col>
            </el-row>
             <el-row>
