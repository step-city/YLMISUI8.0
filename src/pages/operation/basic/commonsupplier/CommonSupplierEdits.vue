<template>
    <yl-layout>
        <div slot="fristbox">
          <yl-toolbar>
                <el-form  :inline="true"  >
                    <el-button type="primary"  v-permissionSetting="'Pages.Operation.Data.CommonSuppliers.DownLoad'" size="small"  @click="_onSubmit" class="icon-download3">下载</el-button>
                    ...
                    get () {
                        return {
                            ...
                            columns: [
                                ...
                                {attr: { prop: 'supplierOrgCode', label: '社会信用代码', width:120,  } }, 
                                {attr: { prop: 'supplierAbbName', label: '简称', width:120,  } },   
                                {attr: { prop: 'supplierTypeName', label: '供应商类别', width:120,  } },   
                                ...
                                {attr: { prop: 'supplierCode', label: '编码', width:100,  } },  
                                {attr: { prop: 'isBlackList', label: '黑名单', width:80, scopedSlot: 'isBlackList',  } },
                                {attr: { prop: 'supplierState', label: '状态', width:80, scopedSlot: 'supplierState', } },  
