...
<div slot="content">
    <yl-layout>
        <div slot="fristbox" >
            ...
            <yl-toolbar>
                <el-button-group>
                        <el-button type="primary"  v-permissionSetting="'Pages.Operation.Data.CommonSuppliers.DownLoad'"   class="icon-download3" size="small"   @click="_downLoad" >下载供应商</el-button>
                        <el-button type="primary" v-permissionSetting="'Pages.Operation.Data.CommonSuppliers.Edit'"   icon="edit"  size="small" :disabled="selectRows.length===0" @click="_edit">编辑</el-button>
                        <el-button type="danger"  v-permissionSetting="'Pages.Operation.Data.CommonSuppliers.Delete'"   icon="delete" size="small"  :disabled="selectRows.length===0" @click="_delete" >删除</el-button>
            </el-button-group>
            </yl-toolbar>
        </div>
