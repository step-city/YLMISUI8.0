    ...
    <el-row>
        <el-col :span="12">
            <el-form-item label="名称" prop="labourName">
                <el-input v-model="formModel.labourName" :disabled="true" ></el-input>
            </el-form-item>
        </el-col>
        <el-col :span="12">
             <el-form-item label="类型" prop="labourTypeName">
                <el-input v-model="formModel.labourTypeName"  :disabled="true"></el-input>
            </el-form-item>
        </el-col>
    </el-row>
    <el-row>
        <el-col :span="12">
            <el-form-item label="信用代码" prop="labourOrgCode">
                <el-input v-model="formModel.labourOrgCode" :disabled="true" ></el-input>
            </el-form-item>
        </el-col>
        <el-col :span="12">
