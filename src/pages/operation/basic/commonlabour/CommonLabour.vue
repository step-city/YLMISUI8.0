...
<div slot="content">
    <yl-layout>
        ...
        <yl-toolbar>
            <el-button-group>
                    <el-button type="primary"  v-permissionSetting="'Pages.Operation.Data.CommonLabours.DownLoad'"   class="icon-download3" size="small"   @click="_downLoad" >下载用料单位</el-button>
                    <el-button type="primary" v-permissionSetting="'Pages.Operation.Data.CommonLabours.Edit'"   icon="edit"  size="small" :disabled="selectRows.length===0" @click="_edit">编辑</el-button>
                    <el-button type="danger"  v-permissionSetting="'Pages.Operation.Data.CommonLabours.Delete'"   icon="delete" size="small"  :disabled="selectRows.length===0" @click="_delete" >删除</el-button>
                </el-button-group>
        </yl-toolbar>
        </div>
                    ...
                    get () {
                        return {
                            ...
                            columns: [
                                ...
                                {attr: { prop: 'isBlackList', label: '黑名单', width:90, scopedSlot:'isBlackList', align: 'center' } },   
