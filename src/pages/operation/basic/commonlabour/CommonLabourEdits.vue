<template>
    <yl-layout>
        <div slot="fristbox">
          <yl-toolbar>
                <el-form  :inline="true"  >
                    <el-button type="primary"  v-permissionSetting="'Pages.Operation.Data.CommonLabours.DownLoad'" size="small"  class="icon-download3" @click="_onSubmit">下载</el-button>
            ...
            tableConfig: {
                    get () {
                        return {
                            ...
                            columns: [
                                {attr: { type: 'selection',label: '选择', width:65, align: 'center'}},
                                {attr: { type: 'index',label: '序号', width:65,align: 'center' }},
                                {attr: { prop: 'labourName', label: '名称', width:120,  } },   
                                 {attr: { prop: 'labourOrgCode', label: '社会信用代码', width:120,  } },  
