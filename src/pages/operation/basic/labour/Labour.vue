...
<div slot="content">
    <yl-layout>
        ...
        <yl-toolbar>
            <el-button-group>
                    <el-button type="primary" v-permissionSetting="'Pages.Operation.Data.Labours.Create'"   icon="plus" size="small"  @click="_add" >添加</el-button>
                    <el-button type="primary" v-permissionSetting="'Pages.Operation.Data.Labours.Edit'"   icon="edit"  size="small" :disabled="selectRows.length===0" @click="_edit">编辑</el-button>
                    <el-button type="danger"  v-permissionSetting="'Pages.Operation.Data.Labours.Delete'"   icon="delete" size="small"  :disabled="selectRows.length===0" @click="_delete" >删除</el-button>
                    <!-- <el-button type="primary" v-permissionSetting="'Pages.Operation.Data.Labours.BlackList'"  class="icon-cog2"  size="small" :disabled="selectRows.length===0" @click="_blackList">黑名单</el-button> -->
                </el-button-group>
        </yl-toolbar>
        </div>
