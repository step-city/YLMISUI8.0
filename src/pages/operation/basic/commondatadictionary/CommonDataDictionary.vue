...
<div slot="content">
  <yl-columnlay>
              <div slot="left"  >
                    <yl-panelpage isZone :helpIsShow="false" :treeLoading="treeLoading" @reload="_treeReload" :reloadIsShow="false" :titleName="'字典树'" :icon="'icon-tree'" :widthNum="'210px'" >
                        <div slot="content">
                ...
                <div slot="right" >
                    <yl-layout>
                        ...
                        <yl-toolbar>
                            <el-button-group>
                                    <el-button type="primary" v-permissionSetting="'Pages.Basic.Set.CommonDataDictionarys.Create'"   icon="plus" size="small"  @click="_add" >添加</el-button>
                                    <el-button type="primary" v-permissionSetting="'Pages.Basic.Set.CommonDataDictionarys.Edit'"   icon="edit"  size="small" :disabled="selectRows.length===0" @click="_edit">编辑</el-button>
                                    <el-button type="danger"  v-permissionSetting="'Pages.Basic.Set.CommonDataDictionarys.Delete'"   icon="delete" size="small"  :disabled="selectRows.length===0" @click="_delete" >删除</el-button>
                                </el-button-group>
                        </yl-toolbar>
                        </div>
