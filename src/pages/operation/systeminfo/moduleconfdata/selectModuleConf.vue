                    ...
                    <div slot="fristbox" >
                        <yl-toolbar>
                                    <el-form  :inline="true"  >
                                        <el-form-item class="form-content-vertical">
                                             <yl-dataDictionaryForSel 
                                                :code="'selectModule'"
                                                     size="small"
                                                     v-model="searchModel.extensionOne"
                                                ></yl-dataDictionaryForSel> 
                                        </el-form-item>
                                        <el-form-item class="form-content-vertical">
                                            <el-input  
                             ...
                             <yl-toolbar>
                                    <el-form  :inline="true"  >
                                        <el-form-item class="form-content-vertical">
                                            <el-button type="primary"  :loading="pullLoading" size="small"   :disabled="searchModel.extensionOne===''" @click="_pull" ><i class="icon-alignment-aligned-to"></i>拉取</el-button>
...
export default {
                    ...
                    get () {
                        return {
                            ...
                            columns: [
                                ...
                                {attr: { prop: 'extensionOne', label: '选择器名称', width:150,  } },
		...
		methods: { 
            ...
            _getDataList(){
                ...
                var inputArr=[ 
                               {key:"ExtensionOne",op:"EQ",value:this.searchModel.extensionOne},
                             ];
                ...
                fetch(
                    {
                        ...
                        method:'post',
                        data:[ 
                             {dataField:"ExtensionOne",op:"EQ",dataValue:_this.searchModel.extensionOne},
                    ...
                    if(data.success){
                        //插入本地
                        let paramsModel=data.result.selectModuleConf;
                        paramsModel.id=''
                        let date=new Date();
