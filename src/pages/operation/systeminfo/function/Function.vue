...
<div slot="content">
     <yl-columnlay>
                <div slot="left"  >
                    <yl-panelpage isZone :helpIsShow="false" :titleName="'功能树'"  :treeLoading="treeLoading"   @reload="_treeReload" :reloadIsShow="false" :icon="'icon-tree'" :widthNum="'200px'" >
                        <div slot="content">
                            <el-tree 
            ...
            tableConfig: {
                    get () {
                        return {
                            ...
                            columns: [
                                {attr: { type: 'selection',label: '选择', width:80,align: 'center' ,"headerAlign": "center" }},
